...
### Data Lineage
  ...
  * Processing Steps
      * rename file to power-cost-equalization-pce-data.csv
...
### Source File
  ...
  * Filename: power-cost-equalization-pce-data-csv-includes-uncleaned-years (directory with data(.csv) and metadata(.html))
  * Date: 04/26/2017
  * Contact Name: N/A
